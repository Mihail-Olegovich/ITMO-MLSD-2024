...
- было проверено качество данных, в результате чего отмечено несколько сложностей: аббревиатуры, специфические обозначения аналитических метрик, которые требуют расшифровки какие формулы лежат ними, неполное несоответствие разметки и sql запроса (не все колонки из ответа упомянуты или не указана гранулярность запроса)
